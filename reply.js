 ...
 */
const replyToTweet = async (rollno, dateofbirth, tweetid, username) => {
  console.log("id", username, "roll", rollno, "dob",dateofbirth,);
  try {
    const screenshot_path = await takeScreenshot(rollno, dateofbirth);
